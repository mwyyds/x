...
proxies:
  - {name: 🇰🇷 ⑤韩国IPV6 IPV4解锁流媒体, server: 144.24.93.29, port: 80, type: vmess, uuid: a6ac62cc-20a6-4134-c3c6-44bd5c118853, alterId: 0, cipher: auto, tls: false, network: ws, ws-path: /, ws-headers: {Host: 144.24.93.29}}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
